...
<div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
    <div class="flex">
        ...
        <div class="ml-3">
            <h3 class="text-sm font-medium text-blue-800">Suppression effectuée</h3>
            <div class="mt-2 text-sm text-blue-700">
                <p>Le distributeur a été supprimé avec succès. Un backup a été créé.</p>
                <div class="mt-3 flex space-x-4">
                    <a href="{{ route('admin.deletion-requests.show', session('deletion_info.request_id')) }}"
                       class="font-medium underline hover:text-blue-600">
                        Voir les détails de la suppression
                    </a>

...
<main class="mn-inner">
    <div class="row">
        <div class="col s12">
            <div class="page-title"><h5>Effectuer un Achat en Différé</h5></div>
        </div>
        <div class="col s12 m12 l8">
            <div class="card">
                <div class="card-content">
                    <span class="card-title">Veuillez insérer les informations relatives à l'achat différé</span><br>
                    <div class="row">
                        <form class="col s12" action="{{ route('achats.stored') }}" method="post">
                            @csrf
                            <div class="row">

...
<main class="mn-inner inner-active-sidebar">
    ...
    <div class="inner-sidebar">
        <span class="inner-sidebar-title">LES NOVUEAUX GRADES</span>
        ...
        <div class="sidebar-radar-chart" style="visibility:hidden"><canvas id="radar-chart" width="170" height="140"></canvas></div>
    </div>
</main>

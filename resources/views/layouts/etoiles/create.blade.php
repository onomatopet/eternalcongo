                        ...
                        <form class="col s12" action="{{ route('etoiles.store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s4">
                                    ...
                                    <input name="cumul_collectif_1" value="" type="text" class="validate">
                            ...
                            <div class="row">
                                <div class="input-field col s4">
                                    ...
                                    <input name="cumul_collectif_2" value="" type="text" class="validate">
                                ...
                                <div class="input-field col s4">
                                    ...
                                    <input name="cumul_collectif_3" value="" type="text" class="validate">
                                ...
                                <div class="input-field col s4">
                                    ...
                                    <input name="cumul_collectif_4" value="" type="text" class="validate">

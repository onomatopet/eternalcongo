        ...
        <div x-show="sidebarOpen" class="relative z-50 lg:hidden" x-cloak>
            ...
            <div class="fixed inset-0 flex">
                <div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <!-- Sidebar mobile - Même structure que desktop -->
                            ...
                            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        ...
                                        {{-- Export Réseau --}}
                                        @if(auth()->user()->hasPermission('view_distributeurs'))
                                        <li>
                                        ...
                                        <li>
                                            <div class="text-xs font-semibold leading-6 text-gray-400 mt-6">Tableau de Bord</div>
                                        ...
                                        <li>
                                            <div class="text-xs font-semibold leading-6 text-gray-400 mt-6">Gestion MLM</div>
                                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                                <li>
                                        ...
                                        <li class="relative">
                                            <details class="group [&_summary::-webkit-details-marker]:hidden">
                                                <summary class="flex items-center justify-between cursor-pointer {{ request()->routeIs('admin.deletion-requests.*') ? 'bg-primary-50 text-primary-600' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50' }} group gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    ...
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        <li>
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                {{-- Section Gestion des processus et données --}}
                                <li>
                                    <div class="text-xs font-semibold leading-6 text-gray-400 mt-6">Gestion des processus</div>
                                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                                        <li>
                                            <a href="{{ route('admin.processes.index') }}" class="{{ request()->routeIs('admin.processes.*') ? 'bg-primary-50 text-primary-600' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        ...
                                        {{-- Suppressions avec sous-menu (CORRIGÉ) --}}
                                        @if(auth()->user()->hasPermission('view_deletion_requests'))
                                        <li class="relative">
                                            <details class="group [&_summary::-webkit-details-marker]:hidden">
                                                <summary class="flex items-center justify-between cursor-pointer {{ request()->routeIs('admin.deletion-requests.*') ? 'bg-primary-50 text-primary-600' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50' }} group gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                                ...
                                                <ul class="mt-2 px-2 space-y-1">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.backups.index') }}"
                                                           class="{{ request()->routeIs('admin.backups.index') ? 'bg-gray-100 text-gray-900' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' }} block rounded-md py-2 pr-2 pl-9 text-sm leading-6">
                                                            Backups
                                                        </a>
                                                    </li>
                                                </ul>
